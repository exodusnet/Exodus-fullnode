...
//            logger.info("++++++++++++++++++++++++++++ the eps of shard-" + i + ": " + shardAvgEps[i]);
		...
		logger.info("********************************************* " + index
				+ " *******************************************");
		logger.info("**************************** the average total cost time for all shards: "
				+ avgTotalTimesSeries[index] + " sec");
		logger.info("**************************** the average total transactions for all shards: "
				+ avgTotalTransactionsSeries[index]);
		logger.info(
				"**************************** the average total events for all shards: " + avgTotalEventsSeries[index]);
		logger.info("**************************** the average latency for all shards: "
				+ (avgTotalTimesSeries[index] / avgTotalEventsSeries[index]) + " sec");
