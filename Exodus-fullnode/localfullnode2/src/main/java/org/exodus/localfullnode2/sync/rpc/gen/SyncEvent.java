...
public class SyncEvent implements java.lang.Cloneable,
                                  java.io.Serializable
{
    ...
    public SyncEvent(int shardId, long selfId, long selfSeq, long otherId, long otherSeq, byte[][] messages, long timeCreatedSecond, int timeCreatedNano, byte[] sign, boolean isFamous, byte[] hash, long generation, long consensusTimestampSecond, int consensusTimestampNano, byte[] otherHash, byte[] parentHash)
    {
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::one::inve::localfullnode2::sync::rpc::gen::SyncEvent");
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, SyncEvent v)
    {
        if(v == null)
        {
    ...
    static public SyncEvent ice_read(com.zeroc.Ice.InputStream istr)
    {
        SyncEvent v = new SyncEvent();
        v.ice_readMembers(istr);
        return v;
    }

    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Optional<SyncEvent> v)
    {
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, SyncEvent v)
    {
    ...
    static public java.util.Optional<SyncEvent> ice_read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            return java.util.Optional.of(SyncEvent.ice_read(istr));
        }
        else
        {
    ...
    private static final SyncEvent _nullMarshalValue = new SyncEvent();

    public static final long serialVersionUID = -1053435287L;
}
