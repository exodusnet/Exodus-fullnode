package org.exodus.localfullnode2.utilities.rocks;
 ...
 *               org.exodus.localfullnode2.utilities.rocks.RocksDBValueByKey 0_0
 *               33AOWttvUncH5ZtU3Jn/bbr4dte7j6BPq7hCxS2TMPIf4OSIJzWbN8UKDZPInQAID9m11XmVnHsmThhyUrpwwYuCc=
 *               <p>
 *               java -classpath localfullnode2-2.0.0.jar
 *               org.exodus.localfullnode2.utilities.rocks.RocksDBValueByKey 0_1
...
public class RocksDBValueByKey {
	...
	public static void main(String[] args) {
		if (args.length > 1 && startRocksDB(args[0])) {
			...
			logger.info(
					"usage: java -classpath localfullnode2-2.0.0.jar org.exodus.localfullnode2.utilities.rocks.RocksDBValueByKey [dbId] [key1] [key2]...");
		}
