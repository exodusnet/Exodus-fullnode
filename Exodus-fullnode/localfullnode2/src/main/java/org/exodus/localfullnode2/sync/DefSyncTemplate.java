...
import org.exodus.localfullnode2.sync.ISyncContext.DefSyncContext;
...
public class DefSyncTemplate implements ISyncConf {
	...
	public String getSynchronizationInitializerClassName() {
		return "org.exodus.localfullnode2.sync.partofwork.SynchronizationWorkInitializer";
	}

	@Override
	public String getSyncSourceProxyClassName() {
		return "org.exodus.localfullnode2.sync.source.ProxiedSyncSource";
	}

	@Override
	public String[] getSynchronizationWorkClassNames() {
		return new String[] { "org.exodus.localfullnode2.sync.partofwork.EventIterativePart",
				"org.exodus.localfullnode2.sync.partofwork.MessageIterativePart",
				"org.exodus.localfullnode2.sync.partofwork.SystemMessageIterativePart" };
	}
	...
	public String getSynchronizationNativeRunnerClassName() {
		return "org.exodus.localfullnode2.sync.partofwork.NativeEventsRunner";
	}
