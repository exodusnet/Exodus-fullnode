package org.exodus.localfullnode2.utilities.nativelib;
 ...
 * @Description: detect os environment
...
public class Environment {
	 ...
	 *
	 * @return the name of the implementation, or null if the default for that
	 *         platform (e.g. glibc on Linux).
	 */
