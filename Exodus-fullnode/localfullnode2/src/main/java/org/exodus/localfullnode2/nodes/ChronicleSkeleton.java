...
import org.exodus.localfullnode2.chronicle.rpc.service.ChronicleServicesRuntime;
import org.exodus.localfullnode2.chronicle.rpc.service.ChronicleServicesServer;
import org.exodus.localfullnode2.dep.DepItemsManager;
import org.exodus.localfullnode2.dep.items.AllQueues;
import org.exodus.localfullnode2.firstseq.EventStoreBility;
import org.exodus.localfullnode2.firstseq.FirstSeqsDependency;
import org.exodus.localfullnode2.firstseq.FirstSeqsbility;
import org.exodus.localfullnode2.http.HttpServiceDependency;
import org.exodus.localfullnode2.lc.ILifecycle;
import org.exodus.localfullnode2.lc.LazyLifecycle;
import org.exodus.localfullnode2.rpc.mgmt.LocalFullNode2RPCInvocationDriver;
import org.exodus.localfullnode2.staging.StagingArea;
import org.exodus.localfullnode2.store.DbUtils;
import org.exodus.localfullnode2.utilities.FileLockUtils;
import org.exodus.localfullnode2.utilities.GracefulShutdown;
import org.exodus.localfullnode2.utilities.PathUtils;
import org.exodus.localfullnode2.utilities.http.NettyHttpServer;
...
//			gs.addLcs(coreTask);
	...
	protected void initOlympus() {
		...
		org.exodus.contract.conf.Config.setCreationAddress(Config.CREATION_ADDRESSES);
		org.exodus.contract.conf.Config.setGodAddress(Config.GOD_ADDRESS);
		org.exodus.contract.conf.Config.setFoundationAddress(Config.FOUNDATION_ADDRESS);
	}
