...
import org.exodus.localfullnode2.snapshot.CreateSnapshotPoint;
import org.exodus.localfullnode2.snapshot.CreateSnapshotPointDependency;
import org.exodus.localfullnode2.snapshot.CreateSnapshotPointDependent;
...
//            }
		...
		try {
			...
			while (!dep.getConsEventHandleQueue().isEmpty()) {// until consEventHandleQueue is empty
				// 取共识Event
				org.exodus.core.EventBody event = dep.getConsEventHandleQueue().poll();
				// 更新共识Event数
