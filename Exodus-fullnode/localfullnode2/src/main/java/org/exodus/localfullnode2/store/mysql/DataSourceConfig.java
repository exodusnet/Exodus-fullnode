package org.exodus.localfullnode2.store.mysql;
...
import org.exodus.localfullnode2.utilities.RSAEncrypt;
...
public class DataSourceConfig {
	...
	public static DruidDataSource getDataSource(String dbId, Boolean isDrop) {
		...
		try {
			...
			StringBuilder sql = new StringBuilder("CREATE DATABASE  IF NOT EXISTS ").append(dataName)
	...
	// introduce the variable of {@see DBConnectionDescriptorsConf}
	public static DruidDataSource getDataSource(String dbId, DBConnectionDescriptorsConf dbConnectionDescriptorsConf,
			Boolean isDrop) {
		String dataSourceUrl = "";
		try {
...
//			String password = PropertyConstants.getPropertiesKey("spring.datasource.password" + dbId);
			...
			dataSourceUrl = dbConnectionDescriptorsConf.getDSURL(dbId);
			String username = dbConnectionDescriptorsConf.getDSUserName(dbId);
			String password = dbConnectionDescriptorsConf.getDSPassword(dbId);
