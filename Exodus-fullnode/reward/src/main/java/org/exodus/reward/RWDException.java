...
public abstract class RWDException extends Exception {

    protected RWDException() {
        super();
    }

    protected RWDException(String message) {
        super(message);
    }

    protected RWDException(String message, Throwable cause) {
        super(message, cause);
    }

    protected RWDException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends RWDException {
