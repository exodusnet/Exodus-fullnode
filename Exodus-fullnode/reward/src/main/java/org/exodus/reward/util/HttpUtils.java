...
public class HttpUtils {
	 ...
	 * @return
	 */
	public static String httpGet(String url) throws IOException, ClassNotFoundException, NoSuchAlgorithmException,
	 ...
	 * @throws IOException
	 */
	public static String httpsGet(String url) throws ClassNotFoundException, KeyManagementException,
	 ...
	 * @throws KeyManagementException
	 */
	public static String httpsPost(String url, HashMap<String, String> params)
			throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException {
	 ...
	 * @param @return 参数
	 * @return String 返回类型
	 * @throws @Title: httpGet
	 */
	public static String httpGet(String url, HashMap<String, Object> maps, boolean https) throws IOException,
			ClassNotFoundException, KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
		// 创建HttpClient上下文
	 ...
	 * @param @return 参数
	 * @return String 返回类型
	 * @throws @Title: httpPost
	 */
	public static String httpPost(String url, HashMap<String, String> params, HashMap<String, Object> config,
			boolean https) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException, IOException {
		// httpClient
