...
import org.exodus.util.HttpUtils;
...
public class ExchangeRateThread extends Thread {
    private static final Logger logger = LoggerFactory.getLogger("ExchangeRateThread.class");
...
//            }
    ...
    public static void main(String[] args) {
        ...
        map.put("INVE:ETH", BigDecimal.valueOf(0.000032368).toString());
        map.put("BTC:ETH", BigDecimal.valueOf(28.676223709).toString());
        map.put("INVE:BTC", BigDecimal.valueOf(0.000001129).toString());
        node.setExchangeRatios(map);
