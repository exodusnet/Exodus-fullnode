...
public interface Register extends com.zeroc.Ice.Object
{
    ...
    String registerRelayNode(String pubkey, String ip, int port, com.zeroc.Ice.Current current);
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_registerRelayNode(Register obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        String iceP_pubkey;
        ...
        inS.endReadParams();
        String ret = obj.registerRelayNode(iceP_pubkey, iceP_ip, iceP_port, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ostr.writeString(ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            ...
            case 18:
            {
                return _iceD_registerRelayNode(this, in, current);
            }
            case 19:
            {
