...
//	}
	...
	// Find fields of the class having the annotation defined on it.
	public static List<Field> findAnnotatedFields(Class clazz, Class fieldAnnClass) {
		List<Field> fields = new ArrayList<Field>();

		for (Field field : clazz.getDeclaredFields()) {
			if (field.isAnnotationPresent(fieldAnnClass)) {
				fields.add(field);
			}
		}
		return fields;
