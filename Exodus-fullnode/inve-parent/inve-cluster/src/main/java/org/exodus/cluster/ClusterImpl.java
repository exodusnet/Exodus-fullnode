package org.exodus.cluster;

import static com.google.common.base.Preconditions.checkElementIndex;
import static com.google.common.base.Preconditions.checkNotNull;
import static org.exodus.cluster.fdetector.FailureDetectorImpl.PING;
import static org.exodus.cluster.fdetector.FailureDetectorImpl.PING_ACK;
import static org.exodus.cluster.fdetector.FailureDetectorImpl.PING_REQ;
import static org.exodus.cluster.gossip.GossipProtocolImpl.GOSSIP_REQ;
import static org.exodus.cluster.membership.MembershipProtocolImpl.MEMBERSHIP_GOSSIP;
import static org.exodus.cluster.membership.MembershipProtocolImpl.SYNC;
import static org.exodus.cluster.membership.MembershipProtocolImpl.SYNC_ACK;

import org.exodus.cluster.fdetector.FailureDetectorImpl;
import org.exodus.cluster.gossip.GossipProtocolImpl;
import org.exodus.cluster.membership.MembershipEvent;
import org.exodus.cluster.membership.MembershipProtocolImpl;
import org.exodus.transport.Address;
import org.exodus.transport.Message;
import org.exodus.transport.NetworkEmulator;
import org.exodus.transport.Transport;
...
final class ClusterImpl implements Cluster {
  ...
  private final List<Member> otherShardMembers = new ArrayList<Member>();
  ...
  @Override
  public Collection<Member> getGroupById(String id){
	    ArrayList<Member> otherMembers = new ArrayList<>(members.values());
	    otherMembers = (ArrayList<Member>) otherMembers.stream().filter(m -> m.metadata().get("group")!=null && m.metadata().get("group").equals(id)).collect(Collectors.toList());
	    return Collections.unmodifiableCollection(otherMembers);
  }
