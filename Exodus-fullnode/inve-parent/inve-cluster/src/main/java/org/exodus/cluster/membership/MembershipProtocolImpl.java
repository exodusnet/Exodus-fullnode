package org.exodus.cluster.membership;

import org.exodus.cluster.ClusterMath;
import org.exodus.cluster.Member;
import org.exodus.cluster.fdetector.FailureDetector;
import org.exodus.cluster.fdetector.FailureDetectorEvent;
import org.exodus.cluster.gossip.GossipProtocol;
import org.exodus.cluster.membership.IdGenerator;
...
import static org.exodus.cluster.membership.MemberStatus.ALIVE;
import static org.exodus.cluster.membership.MemberStatus.DEAD;
...
public final class MembershipProtocolImpl implements MembershipProtocol {
  ...
  private Collection<Member> memebers;
