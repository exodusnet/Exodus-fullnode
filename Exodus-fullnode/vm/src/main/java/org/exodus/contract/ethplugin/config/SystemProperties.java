 ...
 */
package org.exodus.contract.ethplugin.config;

import com.typesafe.config.Config;
import com.typesafe.config.ConfigFactory;
import org.exodus.contract.ethplugin.config.blockchain.OlympicConfig;
import org.exodus.contract.ethplugin.config.net.*;
import org.exodus.contract.ethplugin.core.Genesis;
import org.exodus.contract.ethplugin.core.genesis.GenesisConfig;
import org.exodus.contract.ethplugin.core.genesis.GenesisJson;
import org.exodus.contract.ethplugin.core.genesis.GenesisLoader;
import org.exodus.contract.ethplugin.crypto.ECKey;
import org.exodus.contract.ethplugin.util.ByteUtil;
import org.exodus.contract.ethplugin.util.Utils;
import org.exodus.contract.ethplugin.validator.BlockCustomHashRule;
            ...
            if (genesisJson.getConfig() != null && genesisJson.getConfig().isCustomConfig()) {
                ...
                if (config.hasPath("blockchain.config.name")) {
                    ...
                    try {
                        ...
                        throw new RuntimeException("The class specified via blockchain.config.class '" + className + "' is not instance of org.exodus.contract.ethplugin.config.BlockchainForkConfig", e);
