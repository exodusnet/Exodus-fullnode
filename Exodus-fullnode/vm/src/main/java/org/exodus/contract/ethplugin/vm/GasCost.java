...
public class GasCost {
    ...
    private final int BALANCE = 400;
    private final int SHA3 = 30;
    private final int SHA3_WORD = 6;
    private final int SLOAD = 200;
    private final int STOP = 0;
    private final int SUICIDE = 5000;
    ...
    private final int EXT_CODE_SIZE = 700;
    private final int EXT_CODE_COPY = 700;
