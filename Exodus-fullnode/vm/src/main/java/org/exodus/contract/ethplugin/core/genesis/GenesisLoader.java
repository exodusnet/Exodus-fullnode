 ...
 */
package org.exodus.contract.ethplugin.core.genesis;
...
import org.exodus.contract.ethplugin.db.ByteArrayWrapper;
import org.exodus.contract.ethplugin.trie.SecureTrie;
...
import static org.exodus.contract.ethplugin.core.BlockHeader.NONCE_LENGTH;
import static org.exodus.contract.ethplugin.core.Genesis.PremineAccount;
import static org.exodus.contract.ethplugin.core.Genesis.ZERO_HASH_2048;
import static org.exodus.contract.ethplugin.crypto.HashUtil.EMPTY_LIST_HASH;
import static org.exodus.contract.ethplugin.util.ByteUtil.*;
