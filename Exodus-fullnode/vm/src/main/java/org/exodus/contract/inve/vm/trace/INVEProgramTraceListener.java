...
import org.exodus.contract.ethplugin.vm.program.listener.ProgramListenerAdaptor;

public class INVEProgramTraceListener extends ProgramListenerAdaptor {

    private final boolean enabled;
    private OpActions actions = new OpActions();

    public INVEProgramTraceListener(boolean enabled) {
